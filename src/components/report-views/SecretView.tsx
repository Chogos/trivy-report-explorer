              ...
              {findings.map(secret => (
                ...
                >
                  <td className='px-6 py-4 whitespace-nowrap'>
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSeverityColor(secret.severity)}`}
                    >
                  ...
                  <td className='px-6 py-4'>
                    <div className='text-sm'>{secret.Title}</div>
                  </td>
                  <td className='px-6 py-4 whitespace-nowrap'>
