              ...
              {findings.map((misconfig, index) => (
                ...
                >
                  <td className='px-6 py-4 whitespace-nowrap'>
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSeverityColor(misconfig.severity)}`}
                    >
                  ...
                  <td className='px-6 py-4'>
                    <div className='text-sm'>{misconfig.Title}</div>
                  </td>
                  <td className='px-6 py-4 whitespace-nowrap'>
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                        misconfig.Status === 'FAIL'
