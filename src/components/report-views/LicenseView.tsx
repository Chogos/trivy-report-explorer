                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      license.Category === 'restricted' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'
                    }`}>
                      {license.Category}
                    </span>
                  </td>
                ...
                <table className="min-w-full">
                  <tbody>
                    <tr className="border-t border-github-border">
                      <td className="py-2 pr-4 text-sm font-medium">License Name</td>
                    ...
                    <tr className="border-t border-github-border">
                      ...
                      <td className="py-2 text-sm">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          selectedItem.Category === 'restricted' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'
                        }`}>
                    ...
                    <tr className="border-t border-github-border">
                      <td className="py-2 pr-4 text-sm font-medium">File Path</td>
                      <td className="py-2 text-sm">{selectedItem.FilePath}</td>
                    </tr>
                    <tr className="border-t border-github-border">
                      <td className="py-2 pr-4 text-sm font-medium">Confidence</td>
                      <td className="py-2 text-sm">{Math.round(selectedItem.Confidence * 100)}%</td>
                    </tr>
                  </tbody>
                </table>
